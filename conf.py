...
BLOG_AUTHOR = "John Henderson"  # (translatable)
BLOG_TITLE = "technologeekery"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://jwhendy.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://jwhendy.github.io/"
BLOG_EMAIL = "jw.hendy@gmail.com"
BLOG_DESCRIPTION = "Knowledge, sleep, food and coffee go in; this type of stuff comes out."  # (translatable)
...
# before </head>
# (translatable)
EXTRA_HEAD_DATA = "<style>body{font-size:17px;}</style>"
